...
import core
from scene_vis.core import box_3d_encoder, evaluation
from scene_vis.core import config_utils
from datasets.kitti.obj import obj_utils
from datasets.kitti.obj.obj_utils import Difficulty
from scene_vis.vtk_wrapper.vtk_kitti_boxes import VtkKittiBoxes
...
def create_gt_vtk_boxes(easy_gt_objs, medium_gt_objs, hard_gt_objs,
    ...
    vtk_hard_gt_boxes = VtkKittiBoxes()
    vtk_medium_gt_boxes = VtkKittiBoxes()
    vtk_easy_gt_boxes = VtkKittiBoxes()
    vtk_all_gt_boxes = VtkKittiBoxes()
    ...
    vtk_all_gt_boxes.set_objects(
        all_gt_objs, VtkKittiBoxes.COLOUR_SCHEME_KITTI, show_orientations)
...
def get_max_ious_3d(all_gt_boxes_3d, pred_boxes_3d):
    ...
    if pred_boxes_3d:
        ...
        for gt_obj_idx in range(len(all_gt_boxes_3d)):
            ...
            ious_3d = nova.three_d_iou(gt_obj_iou_fmt,
                                             pred_objs_iou_fmt)
