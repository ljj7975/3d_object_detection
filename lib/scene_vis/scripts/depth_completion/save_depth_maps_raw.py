...
import core
from scene_vis.core import transform_utils
from scene_vis.datasets.kitti.obj import obj_utils
from scene_vis.datasets.kitti.raw import raw_utils
...
def main():
    ...
    for frame_idx, velo_path in enumerate(frames_to_use):
        ...
        projected_depths = DepthMap.from_point_cloud(cam0_point_cloud, cam_info, image_shape)
